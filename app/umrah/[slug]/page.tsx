...
export default function UmrahDetails({ params }: { params: { slug: string } }) {
  const pkg = readPackageBySlug('umrah', params.slug)
    ...
    <div className="section space-y-6">
      <div className="card p-5">
        <div className="flex items-center justify-between">
          ...
          <Link href={`/umrah/${pkg.slug}/book`} className="btn btn-primary">احجز الآن</Link>
        </div>
