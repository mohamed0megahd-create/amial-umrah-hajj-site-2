...
export default function BookUmrah({ params }: { params: { slug: string } }) {
  ...
  useEffect(()=>{
    fetch(`/api/package/${params.slug}?type=umrah`).then(r=>r.json()).then(setPkg)
  }, [params.slug])
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/book', {
        ...
        body: JSON.stringify({ type:'umrah', slug: params.slug, departure, name, email, phone, people, addons })
      })
